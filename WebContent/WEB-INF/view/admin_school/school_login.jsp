...
<body>
    <div id="main">
        ...
        <div id="loginPanel">
            <div id="loginBox">
                <form action="${basePath }/admin_school/login" method="POST">
                    <input type="text" id="userName" name="userName" style="left: 230px; top: 112px;" value="${username }">
                    <input id="password" type="password" name="userPassword" style="left: 230px; top: 164px;">
                    <input type="text" id="randomCode" name="randomCode" style="left: 230px; top:220px; width: 150px;">
