...
<script type="text/javascript">
	...
	window.onload = function(){
		var asideArray=["${basePath }/${param.get('schoolUrl')}/news/1","${basePath }/${param.get('schoolUrl')}/news/2","${basePath }/${param.get('schoolUrl')}/news/3","${basePath }/${param.get('schoolUrl')}/news/4"];
		loadJS(asideArray);
	}
</script>
</body>
