...
<head>
    ...
    <style>
       body{
            background:url(${basePath }/resources_new/img/bg2-1.png) no-repeat center;
        }
    </style>
</head>
<body>
<div id="bg" style="background:url(${basePath }/resources_new/img/bg2-1.png) no-repeat center">
...
<div class="content">
   <div class="logo"><img src="${basePath }/resources_new/img/logo18.png"><span>${schoolName }</span></div>
    ...
    <section id="carousel-example-generic" class="carousel slide lunbo" data-ride="carousel">
   	...
   	<jsp:include page="../common/index_content.jsp"></jsp:include>
