...
<link rel="stylesheet" type="text/css" href="${basePath }/resources/lib/css/bootstrap-select.css">
<link rel="stylesheet" type="text/css" href="${basePath}/resources/wangEditor/dist/css/wangEditor.min.css">
...
<script type="text/javascript" src="${basePath }/resources/lib/js/bootstrap-select.js"></script>
