...
<link rel="stylesheet"
	href="${basePath }/resources_new/css/bootstrap.min.css">
...
<style>
body {
	background: url(${basePath }/resources_new/img/bg3-1.png) no-repeat
		center;
}
</style>
</head>
<body>
	<div id="bg"
		style="background:url(${basePath }/resources_new/img/bg3-1.png) no-repeat center">	
		<jsp:include page="../common/index_ad.jsp"/>
		<div class="content">
			<div class="logo">
				<img src="${basePath }/resources_new/img/logo18.png"><span>${schoolName }</span>
			</div>
			<div class="nav">
				<jsp:include page="../common/title.jsp"/>
			</div>
			<section id="carousel-example-generic" class="carousel slide lunbo"
				data-ride="carousel"> <!-- Indicators -->
		...
		<script src="${basePath }/resources_new/js/jquery-3.1.1.min.js"
			type="application/javascript"></script>
		<script src="${basePath }/resources_new/js/bootstrap.min.js"
			type="application/javascript"></script>
		<script>
			var temp = '${basePath}' + "/${param.get('schoolUrl')}/"
