...
<body>
	...
	<div id="bg" style="background:url(${basePath }/resources_new/img/bg1-2.png) no-repeat center;">
		...
		<section id="main"> <aside id="side">
		<ul>
			<li
				style="background: url(${basePath }/resources_new/img/navbg.png) no-repeat;background-size: 100%;">校园新闻</li>
			<li>教育新闻</li>
			<li>合作交流</li>
			<li>通知公告</li>
		</ul>
		...
		<h2>校园资讯</h2>
		<span>校园资讯</span> <span>/</span> <span>校园新闻</span> </nav> <section
			class="main_iframe">
		...
		<script type="text/javascript"
			src="${basePath }/resources_new/js/primery_second.js"></script>
		<script type="text/javascript">
