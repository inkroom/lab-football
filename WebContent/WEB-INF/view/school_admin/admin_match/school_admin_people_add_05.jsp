...
<body>
	<div class="container">
		<div class="col-xs-12 text-center">
	       <h4 class="title">添加校园球星</h4>
	   	</div>
		<div class="main">
			<form id="hform" enctype="multipart/form-data" action="${basePath }/school_admin/add_people_05" method="post">
		...
		if('${peopleInfo}'!=null && '${peopleInfo}'!=''){
			if('${peopleInfo}'==1){
				layer.confirm('添加成功', {
					...
					window.location.href = '${basePath }/school_admin/get_people_list_05';
				});
			}else{
