...
<body>
	<div class="container">
		<div class="col-xs-12 text-center">
	       <h4 class="title">添加学校领导</h4>
	   	</div>
		<div class="main">
			<form id="hform" enctype="multipart/form-data" action="${basePath }/school_admin/add_people_01" method="post">
				...
				<table class="table table-hover table-bordered text-center" id="myTab">
					<tbody id="tbody">
						...
						<tr>
							<td>照片</td>
							<td colspan="2"><input type="file" name="file" id="file"  class="input-text form-control"/></td>
						</tr>
		...
		if('${peopleInfo}'!=null && '${peopleInfo}'!=''){
			if('${peopleInfo}'==1){
				layer.confirm('添加成功', {
					...
					window.location.href = '${basePath }/school_admin/get_people_list_01';
				});
			}else{
