...
<body>
	<div class="container">
		<div class="col-xs-12 text-center">
	       <h4 class="title">管理学校简介</h4>
	   	</div>
		<div class="main">
			<form id="hform" action="${basePath }/school_admin/update_info_02" method="post">
				...
				<table border="0" style="width:1000px;margin:auto;margin-bottom:10px">
					...
					<tr class="text-c" height="46px" style="">
						<td colspan="2">
							<div id="editor1" style="height:550px;margin: 0px;"><p>${infoMap.content}</p></div>
						</td>
					</tr>
					<tr class="text-c">
						<td colspan="2">
