...
<div class="container">
    <div class="col-xs-12 text-center">
        <h4 class="title">管理校长寄语</h4>
    </div>
    <div class="main">
        <form id="hform" action="${basePath }/school_admin/update_info_01.action" method="post">
            ...
            <table border="0" style="width:1000px;margin:auto;margin-bottom:10px">
                ...
                <tr class="text-c">
                    <td colspan="2">
                        <input style="width:100px;" id="save" class="btn btn-success radius" type="button"
                               onclick="saveContent()" value="保&nbsp;&nbsp;&nbsp;&nbsp;存">
                        <input style="width:100px;margin-left:100px;;" id="clear" class="btn btn-success radius"
                               type="button" onclick="clearContent()" value="清&nbsp;&nbsp;&nbsp;&nbsp;空">
                    </td>
                </tr>
            </table>
        </form>
