...
<body>
	<div class="container">
		<div class="col-xs-12 text-center">
	       <h4 class="title">添加作品展示</h4>
	   	</div>
		<div class="main">
			<form id="hform" enctype="multipart/form-data" action="${basePath }/school_admin/add_feature_05.action" method="post">
		...
		if('${featureInfo}'!=null && '${featureInfo}'!=''){
			if('${featureInfo}'==1){
				layer.confirm('添加成功', {
					...
					window.location.href = '${basePath }/school_admin/get_feature_list_05';
				});
			}else{
