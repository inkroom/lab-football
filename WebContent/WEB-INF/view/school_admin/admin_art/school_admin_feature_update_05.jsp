...
<body>
	<div class="container">
		<div class="col-xs-12 text-center">
	       <h4 class="title">修改作品展示</h4>
	   	</div>
		<div class="main">
			<form id="hform" enctype="multipar  t/form-data" action="${basePath }/school_admin/update_feature_05" method="post">
				...
				<table class="table table-hover table-bordered text-center" id="myTab">
					<tbody id="tbody">
						...
						<tr class="text-c" height="46px" style="">
							<td>介绍</td>
							<td colspan="2">
								<div id="editor1" style="height:550px;margin: 0px;">${featureMap.content}</div>
							</td>
						</tr>
						<tr class="text-c">
