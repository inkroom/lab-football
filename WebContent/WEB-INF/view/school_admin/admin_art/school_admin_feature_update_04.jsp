...
<body>
	<div class="container">
		<div class="col-xs-12 text-center">
	       <h4 class="title">修改艺术课程</h4>
	   	</div>
		<div class="main">
			<form id="hform" enctype="multipart/form-data" action="${basePath }/school_admin/update_feature_04" method="post">
				...
				<table class="table table-hover table-bordered text-center" id="myTab">
					<tbody id="tbody">
						<tr>
							<td>姓名</td>
							<td colspan="2"><input type="text" name="title"  id="title" value="${featureMap.title }" class="input-text form-control"/></td>
						</tr>
						<tr>
							<td>照片</td>
							<td><img alt="" src="${picPath }${featureMap.pic }" width="200px" height="200px"></td>
							
						</tr>
						<tr>
							<td>修改照片(不修改不需要这步操作)</td>
							<td><input type="file" name="file"  class="input-text form-control"/></td>
						</tr>
						<tr class="text-c" height="46px" style="">
							<td>介绍</td>
							<td colspan="2">
								<div id="editor1" style="height:550px;margin: 0px;"><p>${featureMap.content}</p></div>
							</td>
						</tr>
						<tr class="text-c">
