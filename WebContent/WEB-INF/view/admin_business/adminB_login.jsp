...
<body>
    <div id="main">
        ...
        <div id="loginPanel">
            <div id="loginBox">
                <form action="${basePath }/admin_business/login.action" method="POST">
                    <input type="text" name="userName" style="left: 230px; top: 112px;" value="${username }">
                    <input id="password" type="password" name="userPassword" style="left: 230px; top: 164px;">
                    <input type="text" name="randomCode" style="left: 230px; top:220px; width: 150px;">
