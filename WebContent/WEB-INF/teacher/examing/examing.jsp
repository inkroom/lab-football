<%@page import="cn.nsu.ccl.teacher.entity.ExamingInfo"%>
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <tbody>
                            <%List<ExamingInfo> list = (List<ExamingInfo>)request.getAttribute("examList");
                            	for(int i = 0; i < list.size();i++){
                            		ExamingInfo examingInfoEntity = list.get(i);
