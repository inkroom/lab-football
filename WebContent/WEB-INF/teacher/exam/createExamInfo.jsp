...
<!-- Data Tables -->
<link href="${ctx}/assets/css/plugins/dataTables/dataTables.bootstrap.css"
	rel="stylesheet">
						...
						<table
                            ...
                            %>
								<tr class="gradeX">
									...
									<td><%=questionLibListEntity.getmChoice()%></td>
									<td><%=questionLibListEntity.getTofChoice() %></td>
									<td><a href="javascript:void(0);"
										onclick="createExam(
                                    <%=questionLibListEntity.getLibraryId() %>,
                                    '<%=questionLibListEntity.getLibraryName()%>',
                                    <%=questionLibListEntity.getsChoice()%>,
                                    <%=questionLibListEntity.getmChoice()%>,
                                    <%=questionLibListEntity.getTofChoice()%>
                                    )">用此题库创建考试</a></td>
								</tr>
								<%} %>
							</tbody>
