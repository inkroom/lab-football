            ...
            <div class="ibox">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <a href="${pageContext.request.contextPath}/backstage/cooperator/add.html"
                           class="btn btn-primary btn-xs">增加合作单位</a>
                    </div>
                </div>
                <div class="ibox-content">
                    <div class="row m-b-sm m-t-sm">
                        ...
                        <div class="col-md-11">
                            <div class="input-group">
                                <input type="text" placeholder="请输入合作单位名称" class="input-sm form-control" id="searchText"> <span
                    ...
                    <div class="project-list">
                        ...
                        <table class="table table-hover" id="news">
                            ...
                            <c:forEach var="item" items="${coors}">
                                <tr>
                                    <td class="project-status">
                                        ${item.id}
												<%--<span class="label ${(item.status eq 1)?'label-primary':'label-default'}">${(item.status eq 1)?'已':'未'}发布--%>
                                    </td>
                                    <td class="project-title">
                                        <a href="javascript:;" target="_blank">${item.name}</a>
                                        <br/>
                                    ...
                                    <td class="project-actions">
                                        <a href="${pageContext.request.contextPath}/backstage/cooperator/${item.id}/update.html"
...
//                });
    ...
    function del(id) {
        layer.confirm('确认删除该合作单位？', {
            btn: ['确认','取消'] //按钮
        }, function(){
            $.ajax({
                url:'${pageContext.request.contextPath}/backstage/cooperator/'+id+'/del.action',
                dataType:'json',
                success:function (result) {
                    if (result.status===0){
