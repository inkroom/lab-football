...
<div id="wrapper">
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a class="J_menuItem" href="${base_path}/student/stuDocument"><i class="glyphicon glyphicon-eye-open"></i> <span class="nav-label">查看公告</span><span class="fa arrow"></span></a>
                ...
                <li class="line dk"></li>
                <li class="hidden-folded padder m-t m-b-sm text-muted text-xs">
                    <span class="ng-scope">退出实验室</span>
                </li>

                <li >
                    <a class="J_menuItem"  onclick="exitLab()"><i class="fa fa-edit"></i> <span class="nav-label" >退出实验室</span><span class="fa arrow"></span></a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1" style="background-color: #FFFFFF">
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe id="J_iframe" width="100%" height="100%" src="${base_path}/student/stuInformation" frameborder="0" data-id="index_v1.jsp" seamless></iframe><!--欢迎页放在这里-->
        </div>
    </div>
    <!--右侧部分结束-->
</div>
