...
<section class="Hui-article-box">
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> <a href="">首页</a> <span class="c-gray en">&gt;</span> 账号管理 <span class="c-gray en">&gt;</span> 修改密码 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
<script type="text/javascript" src="#{base_path}/lib/jquery.validation/1.14.0/jquery.validate.js"></script>
<script type="text/javascript" src="#{base_path}/lib/jquery.validation/1.14.0/validate-methods.js"></script>
<script type="text/javascript" src="#{base_path}/lib/jquery.validation/1.14.0/messages_zh.js"></script>
<script>
    $(function(){
