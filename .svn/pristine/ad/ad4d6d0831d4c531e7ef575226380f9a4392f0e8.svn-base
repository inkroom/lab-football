...
public class Constants {
	...
	public static final String FM_PATH = "grade_path";
	...
	/* 权限错误的返回地址 */
	public static final String AUTHORITY_ERROR_URL = "/common/error_authority.html";
	
	/* 登录地址 */
	public static final String LOGIN_URL = "/common/none_login.html";

	/** 登录过期提示 **/
	public static final String NO_LOGIN = "__no_login__";
