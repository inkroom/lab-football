...
public class StudentDaoImpl implements StudentDao {
	 ...
	 * @return
	 * @throws Exception 
	 * @see StudentDao#addStudentInfo(cn.nsu.ccl.teacher.entity.StudentInfo, String)
	 */
	public boolean addStudentInfo(int examId,String teacherEmail,StudentInfo studentInfo){
	 ...
	 * @return
	 * @throws Exception
	 * @see StudentDao#getStudentInfo(int)
	 */
	@Override
