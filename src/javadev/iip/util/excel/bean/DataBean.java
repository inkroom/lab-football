...
public class DataBean {
	...
	public DataBean(Element dataElement){
		...
		if(this.isArray){
			...
			}catch(Exception e){throw new RuntimeException("data��ǩ��amongLength��increaseLength���Ա���Ϊһ�����֣�");}
			...
			case "vertical":
				...
				break;
			default:
				throw new RuntimeException("data��ǩ��increaseType����ֵΪhorizontal����vertical��");
			}
		}
		...
		if("image".equals(this.dataType)){
			try{
				...
				throw new RuntimeException("data��ǩ��image-xxx���Ա���Ϊһ��������"+dataElement.attributeValue("image-width")+" "+dataElement.attributeValue("image-height"));
			}
		}
