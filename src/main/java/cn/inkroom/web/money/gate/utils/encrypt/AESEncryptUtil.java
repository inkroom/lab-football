...
//            byte[] bytes = Base64.getDecoder().decode(value);
            byte[] bytes = parseHexStr2Byte(value);
            Cipher cipher = Cipher.getInstance(CIPHER_ALGORITHM);
...
//    Fjg6tXXJAsStfqawid4zfQ==节后=gate
//    RiHvGyd1dUHDmoLyI2WW7g==节后=INK

    public static void main(String[] args) {
        AESEncryptUtil util = new AESEncryptUtil("abcdef0123452126");
        System.out.println("gate加密后"+util.encrypt("gate"));
        System.out.println("INK加密后"+util.encrypt("INK"));
    }
}
