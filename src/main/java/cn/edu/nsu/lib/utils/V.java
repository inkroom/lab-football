...
//                    System.out.println(V.class + "  value =  " + obj);
                    if (v.emptyAble() && isEmpty(obj)) {
                        return;
                    }
                    if (!v.emptyAble() && isEmpty(obj)) {
//                        System.out.println(V.class + "  null  " + obj.toString());
                        throw new MessageException(Result.PARAM_NOT_EMPTY);
