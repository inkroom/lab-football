...
public class CoachPubServiceImpl extends BaseService implements ICoachPubService {
	...
	public CoachPubBean getCoachScoreService(String id) throws Exception {
		...
		int score1 = Integer.parseInt(score.getScWin()) * 3 + Integer.parseInt(score.getScLose()) * 1;
		int score2 = Integer.parseInt(score.getCounWin()) * 3 + Integer.parseInt(score.getCounLose()) * 1;
		int score3 = Integer.parseInt(score.getCityWin()) * 3 + Integer.parseInt(score.getCityLose()) * 1;
		int score4 = Integer.parseInt(score.getpWin()) * 3 + Integer.parseInt(score.getpLose()) * 1;
		int score5 = Integer.parseInt(score.getOtherWin()) * 3 + Integer.parseInt(score.getOtherLose()) * 1;
