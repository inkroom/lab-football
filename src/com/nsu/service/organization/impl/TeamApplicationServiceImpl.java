...
import com.nsu.dao.organization.TeamApplicationDao;
 ...
 *
 */
@Service("iTeamApplicationService")
public class TeamApplicationServiceImpl extends BaseService implements ITeamApplicationService {
	...
	public PageInfo<Map<Object, Object>> findAll(@Param("pageNum") Integer pageNum,
		...
		teamApplicationDao.updateTeamAffiliation(ORG_ID);
		List<Map<Object, Object>> list = teamApplicationDao.findAll(ORG_ID);
	...
	public Map<String, Object> findTeamMessage(long team_id) throws Exception {
		...
		Map<String, Object> TeamMap = teamApplicationDao.findTeamMessage(team_id);
		List<String> coachList = new ArrayList<String>();
		teamApplicationDao.updateTeamOrgID(org_id, team_id);
         coachList = teamApplicationDao.selectCoachByTeamID(team_id);
         String a_name = "";
         if(coachList == null){
 			a_name = "暂无";
 		}
		...
		if(TeamMap != null){
			...
			Map<String, Object> TeamMap2 = teamApplicationDao.findTeamMessage(team_id);
	...
	public List<Map<String, Object>> findPlayerMessage(long team_id) throws Exception {
		 ...
		 playersList = teamApplicationDao.findPlayerMessage(team_id);
	 ...
	 */
	@Override
	public int updateTeamStatus(long team_id) throws Exception {
		int num = teamApplicationDao.updateTeamStatus(team_id);
		if(num == 1){
			return 1;
		}
		return 0;
	 ...
	 */
	@Override
	public int updateTeam(long team_id) throws Exception {
		int num1 = teamApplicationDao.updateTeam(team_id);
		if(num1 == 1){
			return 1;
		}
		return 0;
	...
	public List<Map<Object, Object>> findone(long ORG_ID, String comName) throws Exception {
		...
		return teamApplicationDao.findone(ORG_ID, comName);
	}
	...
	public int selectAId(long org_id) throws Exception {
		...
		return teamApplicationDao.selectAId(org_id);
	}
	...
	public String selectOrgName(long org_id) throws Exception {
		return teamApplicationDao.selectOrgName(org_id);
	}
