...
public class OrgCreateMatchServiceImpl extends BaseService implements IOrgCreateMatchService {
	...
	public boolean isDuplicationMatchName(long o_id, String match_name) throws Exception {
		return orgCreateMatchDao.isDuplicationMatchName(o_id, match_name)==0;
//		boolean mask = false;
//		Long result = orgCreateMatchDao.isDuplicationMatchName(o_id, match_name);
//		if(result == 0){
//			mask = true;
//		}
//		return mask;
	...
	public boolean addMatchInfo(long o_id, Map<String, String> match_info, 
		...
		if(addMatchInfoResult == 1){
			Long com_id = selectMatchID(o_id, match_info.get("match_name"));
	...
	@Override
	public Long selectMatchID(long o_id, String match_name) throws Exception {
