...
public class CoachInfoServiceImpl extends BaseService implements CoachInfoService{
	...
	public Map<String, Object> getCoachInfoBase(String coachID) {
		...
		if (map.get(CommonVar.Account.ID_CARD)==null) {
			map.put(CommonVar.Account.ID_CARD, "/");
		}else {
			map.put(CommonVar.Account.ID_CARD, InfoProUtil.xorInfo(map.get(CommonVar.Account.ID_CARD).toString()));
