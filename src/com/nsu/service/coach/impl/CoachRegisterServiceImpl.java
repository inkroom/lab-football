...
public class CoachRegisterServiceImpl extends BaseService implements CoachRegisterService{
	...
	public boolean checkCoachRegIdNum(String idNum) {
		int i = coachRegisterDao.checkCoachRegIdNum(InfoProUtil.xorInfo(idNum));
	...
	public boolean checkCoachRegPhone(String phone) {
		int i = coachRegisterDao.checkCoachRegPhone(InfoProUtil.xorInfo(phone));
	...
	public boolean insertCoachRegister(String IdNum, String passwd, String phone) {
		try {
			coachRegisterDao.addCoachToAccount(InfoProUtil.xorInfo(IdNum),passwd, InfoProUtil.xorInfo(phone));
			birth =getUserBirthday(IdNum);
			coachRegisterDao.addCoachToCoach(coachRegisterDao.getCoachAId(InfoProUtil.xorInfo(phone)),birth);
	...
	public String selectCoachID(String phone) {
		...
		return coachRegisterDao.selectCoachID(InfoProUtil.xorInfo(phone));
	}
	@Override
