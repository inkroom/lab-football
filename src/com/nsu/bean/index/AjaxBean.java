...
import com.nsu.service.common.impl.HttpSessionCsrfTokenRepository;
...
public class AjaxBean {
    ...
    @JsonProperty("token")
    private CsrfTokenBean csrfTokenBean;
    ...
    public void setBody(String attribute,Object o) {
        body.put(attribute,o);
    }
    ...
    public AjaxBean(boolean createToken, HttpSession session){
        try {
            csrfTokenBean = (CsrfTokenBean)session.getAttribute(HttpSessionCsrfTokenRepository.class
