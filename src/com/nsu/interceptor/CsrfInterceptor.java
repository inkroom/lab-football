...
import com.nsu.utils.ClearXssUtil;
...
public class CsrfInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (interceptorAnno.isRestful()){
            if (!request.getServletPath().equals(ClearXssUtil.clearAll(request.getServletPath()))){
                log.error(" XSS URL"+request.getServletPath());
                response.sendRedirect(request.getContextPath()+"/"+ClearXssUtil.clearAll(request.getServletPath().toString()));
                return false;
            }
        }
