...
public interface CoachInfoDao {
	 ...
	 * @param coach
	 */
	int saveCoachEditInfo(@Param("coach")CoachInfoBean coach);
	/**
	 * 教练头像上传
	 * @param imgStr
	 * @param path
	 ...
	 * @throws Exception
	 */
	public List<Map<String, Object>> getWdpic(@Param("coachID")String coachID);
	 ...
	 * @param A_ID
	 */
	public int saveEmail(@Param("A_EMAIL_CHECK_CODE")String A_EMAIL_CHECK_CODE,@Param("A_ID")String A_ID);
	/**
	 * 获取用户的邮件验证码
	 * @param A_ID
	 * @return
