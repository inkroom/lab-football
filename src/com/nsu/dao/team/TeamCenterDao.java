...
public interface TeamCenterDao {
	 ...
	 * @return
	 */
	public Long findAIDBYPID(String P_ID) throws Exception;
	 ...
	 * @return
	 */
	public Long findAIDBYCOACHID(String COACH_ID) throws Exception;
	 ...
	 * @return
	 */
	public Long findAIDBYORG(String ORG) throws Exception;
}
