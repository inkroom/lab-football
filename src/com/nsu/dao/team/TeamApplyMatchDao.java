...
public interface TeamApplyMatchDao {
	 ...
	 * @throws Exception
	 */
	 List<TeamApplyMatchBean> findTeamMatchs(String teamID) throws Exception;
	 ...
	 * @throws Exception
	 */
	 int findMathContinue(String comID)throws Exception;
	 ...
	 * @throws Exception
	 */
	 String findTeamAlreadyApply(Map<String, Object> map)throws Exception;
