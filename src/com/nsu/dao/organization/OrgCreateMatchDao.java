...
public interface OrgCreateMatchDao {
	 ...
	 * @throws Exception
	 */
	public int selectMatchID(@Param("o_id")long o_id,@Param("match_name")String match_name) throws Exception;
	 ...
	 * @throws Exception
	 */
	public int isDuplicationMatchName(@Param("o_id")long o_id, 
	...
	public int addMatchMsg(@Param("a_id")int a_id, @Param("o_id")long o_id, 
			...
			@Param("msg_text")String msg_text, @Param("com_id")int com_id) throws Exception;
}
