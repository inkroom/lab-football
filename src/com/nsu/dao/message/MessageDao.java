 ...
 * @Package com.nsu.dao.message  
 * @Description:查看消息DAO  
 * @author 朱明民 
 * @date 2017年4月13日 上午11:15:47
 * @version V1.0 
 */
package com.nsu.dao.message;
...
public interface MessageDao {
	 ...
	 * @throws Exception
	 */
	public void insertPersonMsg(@Param("A_ID") int A_ID, @Param("PS_ID") int PS_ID) throws Exception;
	/**
	 * 将系统未读消息标记插入用户消息表
	 * @param A_ID
	 * @param SM_ID
	 * @throws Exception
	 */
	public void insertUserMessage(@Param("A_ID") int A_ID, @Param("SM_ID") int SM_ID) throws Exception;
	 ...
	 * @throws Exception
	 */
	public void allReadMessage(@Param("A_ID") int A_ID) throws Exception;
	 ...
	 * @throws Exception
	 */
	public void allReadMessagePerson(@Param("A_ID") int A_ID) throws Exception;
