...
public interface PlayerLoginDao {
	 ...
	 * @throws Exception
	 */
	public Long getA_ID(@Param("user") String user) throws Exception;
	 ...
	 * @throws Exception
	 */
	public int updateBir(@Param("bir") String bir, @Param("a_id") long a_id) throws Exception;
	 ...
	 * @throws Exception
	 */
	public Long getPid(@Param("a_id") Long a_id) throws Exception;
}
