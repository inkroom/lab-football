...
public class Constants {
	...
	public static final String AndroidUserName = "_AndroidUserName_";

	public static final String AndroidPassword = "_AndroidPassword_";

	public static final String AndroidIMED = "_AndroidIMED_";

	public static final String AndroidTime = "_AndroidTime_";
	...
	/* 登录用户ID在用户信息map中的C_ID */
	public static final String LOGIN_USER_C_ID = "_LOGIN_USER_C_ID_";
	...
	/* 权限错误的返回地址 */
	public static final String AUTHORITY_ERROR_URL = "/error_authority.html";

	/* 登录地址 */
	public static final String LOGIN_URL = "/login_view.html";
	/* 球员登录键值 */
	public static final String PLAYER_LOGIN_USER_ID =  "_PLAYER_LOGIN_USER_ID_";	
	/* 登录后教练员信息在Session中的Key */
	public static final String COACH_LOGIN_USER = "_COACH_LOGIN_USER_";
}