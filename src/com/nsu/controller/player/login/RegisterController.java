...
public class RegisterController extends BaseController {
	...
	public String registe(HttpSession session, String user, String passwd, String passwd2, String phone,
		...
		if (idCardIsExist(InfoProUtil.xorInfo(user))) {
			return userIsExist;
		}
		if (!passwdCompare(passwd, passwd2)) {
			return passwdIsDifferent;
		}
		if (userIsExist(InfoProUtil.xorInfo(phone))) {
			return phoneIsExist;
		}
		/*
		 ...
		 */
		try {
			if (playerLoginService.insertUser(InfoProUtil.xorInfo(user), passwd, InfoProUtil.xorInfo(phone),
	...
	public static void main(String[] args) {
		System.out.println(InfoProUtil.xorInfo("62654>1?203"));
	}
}
