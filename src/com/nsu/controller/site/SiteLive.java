...
@Controller
@RequestMapping("site")
public class SiteLive extends UploadBaseController {
    ...
    public String gameLive(Model model, HttpSession session) throws ParseException {
        ...
        return SitePages.SITE_GAMELIVE;
    ...
    @ResponseBody
    public void insertInfo(com.nsu.bean.site.SiteLive siteLive, HttpServletRequest request,
    ...
    public void PreInfo(HttpServletRequest request, HttpServletResponse response, String name, String phone,
        ...
        @SuppressWarnings("unchecked")
        Map<String, String> map = (Map<String, String>) session.getAttribute(Constants.LOGIN_USER);
        int AID = Integer.parseInt(map.get("A_ID"));
...
//        }
        ...
        return SitePages.REDIRECT_SITE_JUDEMENT;
    }
}
