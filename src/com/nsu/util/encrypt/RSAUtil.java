...
public abstract class RSAUtil {
    ...
    static {
        System.out.println("123asdfasdfasdfdsafasdf");
        try {
        ...
        System.out.println(rsaPairFile);
    }
    ...
    private static String getRSAPairFilePath() {
        String urlPath = NewFileUtils.getBasePath("aa");
    ...
    private static void saveKeyPair(KeyPair keyPair) {
        ...
        try {
            fos = NewFileUtils.openOutputStream(rsaPairFile);
            oos = new ObjectOutputStream(fos);
            oos.writeObject(keyPair);
        } catch (Exception ex) {
            ex.printStackTrace();
        } finally {
        	NewFileUtils.closeQuietly(oos);
        	NewFileUtils.closeQuietly(fos);
        }
    }
    ...
    private static KeyPair readKeyPair() {
        ...
        try {
            fis = NewFileUtils.openInputStream(rsaPairFile);
        	...
        	NewFileUtils.closeQuietly(ois);
        	NewFileUtils.closeQuietly(fis);
        }
        return null;
    }
