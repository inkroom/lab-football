...
/**
 * @ClassName FormatPattern
 * @Description TODO(通用正则验证)
 * @author hm
 * @Date 2017年4月11日 上午10:45:25
 * @version 1.0.0
 */
public class FormatPattern {
    ...
    /**
     * 密码校验，可以为任意6-18位的数字或字母
     * @param passwd
     * @return true为符合，false为不符合
     */
    public static boolean passwdFormat(String passwd){
    	String format="^[0-9a-zA-Z]{6,18}$";
