...
<section class="Hui-article-box">
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> <a href="首页.html">首页</a>  <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="right-c"><img src="../../../resources/img/TeacherAndSchoolAndMechanism/background2.jpg" width="100%" height="850px"></div>
    <div class="welcome">
