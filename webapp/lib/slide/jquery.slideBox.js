...
(function($) {
 ...
 jQuery(function($){
        ...
        $('.information li').each(function(index){

            $('.information li').eq(index).click(function(){
                $('.information li').removeClass('active');
                $('.information').siblings('.article-list').hide();

                $(this).addClass('active');
                $('.information').siblings('.article-list').eq(index).show();
        ...
        $('.notice li').each(function(index){
            ...
            $('.notice li').eq(index).click(function(){
                $('.notice li').removeClass('active');
                $('.notice').siblings('.article-list').hide();

                $(this).addClass('active');
                $('.notice').siblings('.article-list').eq(index).show();
 ...
 function setTime(){
	 ...
	 time.innerHTML=strYear+strMonth+strDay+strWeek;   
	}
	setInterval("setTime()",1000);

	$(document).ready(function(){
		
	    var rand = parseInt(Math.random() * (4 - 0) + 1);
	    $("#container").addClass("banner"+rand);
	});
