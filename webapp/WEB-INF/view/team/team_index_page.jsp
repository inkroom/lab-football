...
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"><a class="logo navbar-logo f-l mr-10 hidden-xs">球队系统</a>
            <nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
                <ul class="cl">
                    <li class="dropDown dropDown_hover">
                        <a href="#" class="dropDown_A">${_LOGIN_USER_.aName}<i class="Hui-iconfont">&#xe6d5;</i></a>
                        <ul class="dropDown-menu menu radius box-shadow">
                            ...
                            <li><a href="${base_path }/team/login_out.html">退出</a></li>
                        </ul>
                    </li>
...
<aside class="Hui-aside">
    ...
    <div class="menu_dropdown bk_2">
        <dl id="menu-message">
            <dt><i class="Hui-iconfont">&#xe616;</i> 球队中心<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
            <dd>
                <ul>
                    <li><a data-href="${base_path }/team/team_center_view.html" data-title="球队中心"
                           href="javascript:void(0)">球队中心</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-team">
            ...
            <dd>
                <ul>
                    <li><a data-href="${base_path }/team/team_manage_view.html" data-title="成员管理"
                           href="javascript:void(0)">成员管理</a></li>
                    <li><a data-href="${base_path }/team/team_player_view/1.html" data-title="球员申请管理"
                           href="javascript:void(0)">球员申请管理</a></li>
                    <li><a data-href="${base_path }/team/team_coach_view/1.html" data-title="教练员申请管理"
                           href="javascript:void(0)">教练员申请管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-match">
            <dt><i class="Hui-iconfont">&#xe620;</i> 球队比赛<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
            <dd>
                <ul>
                    <li><a data-href="${base_path }/team/team_match_view/1.html" data-title="球队比赛"
                           href="javascript:void(0)">球队比赛</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-apply">
            <dt><i class="Hui-iconfont">&#xe620;</i> 比赛申请<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
            <dd>
                <ul>
                    <li><a data-href="${base_path }/team/team_apply_view/1.html" data-title="比赛申请"
                           href="javascript:void(0)">比赛申请</a></li>
                </ul>
            </dd>
        </dl>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content radius">
            ...
            <div class="modal-footer">
                <div class="btn-group">
                    <a class="btn  btn-warning radius" href="${base_path}/team/login_out.html"><i
                            class="Hui-iconfont"></i>退出登录</a>
                    <a onclick="coach_edit('球队信息编辑','team_edit.html','1','800','500')"
                       class="btn btn-success radius f-r"><i class="Hui-iconfont"></i> 编辑信息</a>
                </div>
            </div>
        </div>
    </div>
...
<!-- 初次登录绑定邮箱弹窗 -->
<div id="modal-demo_team_info" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true" style="" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content radius">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div class="text-l ml-20 ">
                    <span class="ml-50">邮箱:</span>
                    <input type="text" placeholder="xxx@xxx.com" id="email1" name="email1"
                           class="input-text radius size-S ml-10" style="width:250px;">
                    <input class="btn btn-primary radius" style="font-size:12px;" type="button" value="免费获取验证码"
                           id="sendEmail1">
                    <p></p>
                    <span class="ml-15">邮箱验证码:</span><input type="text" class="input-text radius size-S ml-10 mr-60"
                                                            placeholder="" maxlength="6" id="code1" name="code1"
                                                            style="width:250px;">
                </div>
            ...
            <div class="modal-footer">
                <a class="btn  btn-warning radius" href="${base_path}/team/login_out.html"><i class="Hui-iconfont"></i>退出登录</a>
                <button class="btn btn-primary" id="checkPtNum1">确定</button>
...
<input type="text" id="typePhone" hidden="" value="4">
...
<script type="text/javascript" src="${base_path}/resources/js/team//page/team_index.js"></script>
...
<script>
    ...
    $("#modal-demo2 a.close,#closed").click(function () {
        $("#modal-demo2 form table").remove();
        $("#next-step").remove();
    ...
    $(function () {
        if ("${_LOGIN_USER_.infoImporveLevel}" > 0) {
            if ("${_LOGIN_USER_.infoImporveLevel}" < 2) {
                $('#modal-demo_team_info').modal({
                    show: true,
                    backdrop: true
                });
            } else {
