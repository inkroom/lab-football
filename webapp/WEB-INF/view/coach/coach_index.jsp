...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs">教练员系统</a>
			<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
				<ul class="cl">
					<li class="dropDown dropDown_hover">
					
						<a href="#" class="dropDown_A"><c:choose><c:when test="${ sessionScope._LOGIN_USER_.A_NAME==null}">${ sessionScope._LOGIN_USER_ID_}</c:when><c:otherwise>${ sessionScope._LOGIN_USER_.A_NAME}</c:otherwise></c:choose>  <i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
							...
							<li><a href="${base_path}/coach/logout.html">退出</a></li>
					</ul>
				</li>
					<li id="Hui-msg"><a onclick="check()" data-href="message-all.html" href="javascript:void(0)"title="消息中心"><span class="badge badge-danger" id="countMessage"></span><i class="Hui-iconfont" style="font-size:18px">&#xe68a;</i></a>
			</ul>
		</nav>
	</div>
</div>
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		<dl id="menu-message">
			...
			<dd>
				<ul>
					<li><a data-href="${base_path}/coach/baseinfo.action" data-title="个人中心" href="javascript:void(0)">个人中心</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-team">
			...
			<dd>
				<ul>
					<li><a data-href="${base_path}/coach/coach_team.action" data-title="我的球队" href="javascript:void(0)">我的球队</a></li>
			</ul>
		</dd>
	</dl>
	<dl id="menu-match">
			...
			<dd>
				<ul>
					<li><a data-href="${base_path}/coach/apply_info.action" data-title="申请球队" href="javascript:void(0)">申请球队</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-match">
			...
			<dd>
				<ul>
					<li><a data-href="${base_path}/coach/match.action" data-title="我的比赛" href="javascript:void(0)">我的比赛</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-training">
			...
			<dd>
				<ul>
					<li><a data-href="${base_path}/coach/training.action" data-title="发布训练" href="javascript:void(0)">发布训练</a></li>
				</ul>
			</dd>
		</dl>
</div>
				...
				<form action="#">
					<table class="table">
						<tr>
							...
							<td>
								<input type="text" class="input-text radius"  name="old_phone"  id="old_phone"  disabled="disabled"/>
							</td>
						</tr>
						<tr>
							<td class="text-r"><p class="f-16 mr-10">验证码:</p></td>
							<td><input type="text" class="input-text radius" placeholder="验证码"  id = "oldPhoneCode" style="width: 70%"/>
								<input type="button" class="btn btn-default radius sendcode"  onclick="MatchCodeDialog(1)" value="获取验证码"></input></td>
						</tr>
					</table>
				</form>
...
<div id="modal-demo_info" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content radius">
            <div class="modal-header">
           ...
           <div class="modal-body">
           		<span>请完成基本信息,再继续操作</span>
               <a onclick="coach_edit('教练员信息编辑','${base_path}/coach/editinfo/get.action','1','800','500')" class="btn btn-success radius f-r"><i class="Hui-iconfont"></i> 编辑信息</a>
             <a  style="float:right" class="btn  btn-warning radius" href="${base_path}/coach/logout.action"><i class="Hui-iconfont"></i>退出登录</a>
				...
				<form>
					<table class="table">
						<tr>
							...
							<td>
								<input type="text" class="input-text radius"  name="old_email" id="old_email"  disabled="disabled"/>
							</td>
						</tr>
						<tr>
							<td class="text-r"><p class="f-16 mr-10">验证码:</p></td>
							<td><input type="text" class="input-text radius" placeholder="验证码" id = "oldEmailCode" style="width: 70%"/>
								<input type="button" class="btn btn-default radius sendemailcode" onclick="old_email_code()" value="获取验证码"></input></td>
						</tr>
					</table>
				</form>
			</div>
...
<input type="text" id="typePhone" hidden="" value="2">
<input type="text" id="SMSPhone" hidden="" value="${SMSPhone }">
<input type="text" id="SMSEmail" hidden="" value="${sessionScope.SMSEmail }">    
<input type="text" id="SMSPhoneCode" hidden="" value="${sessionScope.VERIFY_CODE }">
<!--_footer 作为公共模版分离出去-->
...
function modaldemo(){
   ...
   function nextstep_phone(){
    ...
    $(document).ready(function(){
    	if('${_LOGIN_USER_.A_NAME}'==null || '${_LOGIN_USER_.A_NAME}' == ''){
