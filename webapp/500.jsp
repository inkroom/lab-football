...
<body>
    <article class="page-404 minWP text-c" style="margin-top: 200px">
        <p class="error-title"><i class="Hui-iconfont va-m">&#xe688;</i>
            <span class="va-m"> 500</span>
        </p>
        <p class="error-description">不好意思，服务器异常，请联系管理人员~</p>
        <p class="error-info">您可以：
            <a href="javascript:history.go(-1)" class="c-primary ml-20">返回 &gt;</a>
        </p>
    </article>
</body>
</html>