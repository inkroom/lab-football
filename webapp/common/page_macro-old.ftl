  ...
  <div class="name">
    ...
    <#if Session["_LOGIN_USER_"]?exists>， 
    	<#switch Session["_LOGIN_USER_"].TYPE>
			<#case 0>${Session["_LOGIN_USER_"].STU_NAME}【学生，学号：${Session["_LOGIN_USER_"].STU_NO}】<#break>
  	 ...
  	 <div id="menu">  
	    <ul id="nav">
	     <li><a href="${base}/pro/pro!proList.action">选择项目</a></li>
		 <li><a href="${base}/pro/pro!contactView.action">填写联系方式</a></li>
	    </ul>
	  </div>
...
<div id="main_middle" class="layout">
  ...
  <div id="footer" class="layout">
    <div class="text"> Mobile:13550215532; QQ:191309045 </div>
  </div>
 </div>
</body>
</html>
