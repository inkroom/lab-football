...
var base_path=pathName.substring(0,pathName.substr(1).indexOf('/')+1); //获取当前项目名字
...
//	});
	...
	var uploader = WebUploader.create({
		...
		// 文件接收服务端。
		server : base_path+'/coach/upload_photos.action',
...
(function($) {
	...
	$(function() {
		...
		uploader = WebUploader.create({
			...
			chunked : false,
			chunkSize : 512 * 1024,
			server : base_path+'/coach/upload_photos.action',//is here start file upload
			// runtimeOrder: 'flash',
