...
function loadData(value) {
	...
	var level = value.TEAM_AFFILIATION;
	...
	var team_com_status="'"+value.TEAM_COM_STATUS+"'";
	var com_name="'"+value.COM_NAME+"'";
	...
	+'<td>'+level+'</td>'
    +'<td>'+status+'</td>'
    +'<td>'+'<button class="btn btn-success radius btn_data_name" onclick="modaldemo('+team_name+','+team_com_status+','+com_name+','+team_id+')">查看详情</button>'+'</td>'
+'</tr>');
